...
Vagrant.configure('2') do |config|
  ...
  config.vm.define 'mssqlsrvr1_dbsrvr' do |machine|
    machine.vm.box = "centos/7" #Test with RedHat7
    ...
    machine.vm.network "forwarded_port", guest: 1433, host: 11443 #Access SQL Server from Development host
    ...
    machine.vm.provision 'ansible' do |ansible|
      ...
      ansible.extra_vars = {sa_password: "My?Password12345"}
    end
